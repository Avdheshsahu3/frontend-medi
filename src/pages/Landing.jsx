    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_#f6faf8,_#d8e4e1_72%)] px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-10">
        <header className="flex items-center justify-between rounded-full border border-white/10 px-4 py-3 backdrop-blur navbar-surface sm:px-6">
          ...
          <Link
            to="/login"
            className="rounded-full bg-[#2563C9] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#1D4FA3]"
          >
            Sign in
          </Link>
        </header>
          ...
          <section className="grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  to="/login"
                  className="rounded-2xl bg-[#2563C9] px-5 py-3 font-semibold text-white transition hover:bg-[#1D4FA3]"
                >
                  Get started
                </Link>
              </div>
